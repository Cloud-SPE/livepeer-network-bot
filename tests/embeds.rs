...
fn orch_fixture(
    ...
    OrchestratorProfileRow {
        ...
        total_stake: "0".into(),
        fee_cut_percent: fee_cut_percent.to_string(),
        fee_share_percent: "0".into(),
        reward_cut_percent: "0".into(),
        is_active: true,
        as_of_block: "0".into(),
        as_of_round: None,
...
fn gateway_fixture(addr: &str, name: &str, kind: &str) -> GatewayProfileRow {
    GatewayProfileRow {
        ...
        avatar_url: None,
        kind: kind.to_string(),
        latest_deposit: "0".into(),
        latest_reserve: "0".into(),
        reserve_claimed_in_current_round: "0".into(),
        withdraw_round: "0".into(),
